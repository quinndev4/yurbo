...
// Directly copied from another API route. But it should just get a json list of all event coordinates from your yurbos

export async function PUT(request: CreateEventRequest) {
